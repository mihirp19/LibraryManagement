...
class RequestBooksAdapter(var context: Context, var bookList: ArrayList<Book>) :
    RecyclerView.Adapter<RequestBooksAdapter.BooksViewHolder>() {
    ...
    inner class BooksViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val ivRequestBook = itemView.findViewById<ImageView>(R.id.iv_request_book)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BooksViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_request_book, parent, false)
    ...
    override fun onBindViewHolder(holder: BooksViewHolder, position: Int) {
        ...
        holder.ivRequestBook.setOnClickListener {
            onRequestClickListener?.let { click ->
                click(book)
            }
        }
